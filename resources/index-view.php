                  ...
                  <div class="card mt-3">
                    ...
                    <div class="card-body p-3">
                      <ul class="nav nav-pills justify-content-center mb-3">
                        ...
                        <li class= "nav-item">
                          <a href="?comp=0" class="nav-link">قيد التنفيذ</a>
                        </li>

                        <li class= "nav-item">
                          <a href="?comp=1" class="nav-link">مكتمل</a>
                        </li>
                        ...
                        <?php foreach ($tasks as $task) : ?>
                          ...
                          <div class="p-1">
                            <a href="task/update?id=<?=$task->id?>&comp=<?= $task->comp ? '0' : '1' ?>">
                              <i class="bi fs-5 <?= $task->comp ? 'bi-check-square' : 'bi-clock text-secondary' ?>"></i>
